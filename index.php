...
get_header(); ?>
        ...
        <div class="alert alert-dismissible alert-info">
            <strong><?php _e( 'index.php', 'lazy_days' ); ?></strong>
        </div>
        <section class="bgimage d-flex" style="background-image: url('<?php echo esc_url( get_template_directory_uri() ); ?>/assets/header-3-bg.jpg');
